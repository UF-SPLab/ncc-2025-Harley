...
- **mind-body problem** : the problem of how private experience and subjective awareness can arise from the objective matter that comprises neurons and the brain.

- **philosophy of mind** : The branch of philosophy that studies mind, consciousness, mental states, and their relations to the brain, body, and world.

- **thought experiment** : the process of investigating our beliefs about the mind by taking some scenario and thinking through the consequences; examples include mary the scientist when considering the knowledge argument.
- **intuition pump** : a term coined by dennett to refer to a small thought problem constructed to garner our intuitions about important philosophical questions. bear in mind our intuitions might not always be correct.
...
- **mereological fallacy** : confusing the brain and mind by making statements such as “the brain believes”, when it is only a mind that can believe.
- **qualia/quale** : the elements of sensation; the individual components of conscious experience

- **substance dualism/Cartesian dualism** : the same as cartesian dualism - the idea that there are two basic types of substance, mind and matter.

- **res extensa** : “Extended substance” in Descartes: matter that occupies space.
- **res cogitans** : “Thinking substance” in Descartes: mind or consciousness.

- **pineal gland** : A small gland near the centre of the brain between the two hemispheres. Thought to be the seat of the soul and where mind interacts with matter by Descartes, it produces melatonin.
...
- **monism** : the doctrine that says that there is only one type of substance - mind or matter. contrast dualism.  
- **dualism** : the idea that there are two basic sorts of substance - that mind and matter are completely different kinds of thing. contrast monism.  

- **idealism** : a form of monism that says that mind is all there is. 

- **materialism/physicalism** : the philosophical proposal that matter is the only fundamental kind of stuff in the universe, and all processes, including consciousness, can be explained in terms of matter.

- **determinism** : the notion that everything is already determined by previous events. the laws of physics mean that every event now can only have one outcome, which has already been determined. Superficially, at least determinism rules out free will, as the outcome of choices has already been determined.
...
- **parallelism** : The view that mental and physical events run in coordinated parallel without direct causal interaction (e.g., Leibniz’s pre-established harmony).
- **occasionalism** : The view that God (or a fundamental cause) coordinates mental and physical events on each “occasion”; no direct mind–body causation.
- **dendron** : In Eccles’s dualist-interactionist model, a functional cluster of cortical dendrites posited as the neural unit that interfaces with the mind.
- **psychon** : In Eccles’s model, a putative unit of conscious experience or intention that interacts with a dendron.

- **property dualism** : One kind of substance (physical) but with irreducible mental properties that depend on, yet are not identical to, physical properties.

- **emergentism or emergence** : the way in which complex properties and behaviour emerge from the interaction of many simple properties.  
...
- **knowledge argument** : An argument illustrated by the thought experiment of Mary the scientist who sees the world in black and white and then is given a coloured rose; Is it possible to know all there is about colour without experiencing it? The knowledge argument is considered to be one of the strongest ripostes to materialism. 

- **inverted spectrum** : A thought experiment, whereby individuals "see" different colors; for example, when I have the sensation of red, you have the sensation of blue. How could we ever know? 


- **argument by analogy (other minds)** : The inference that others have minds because their bodies and behaviors are relevantly like ours, which we know are accompanied by mentality.
- **congenital analgesia** : A rare condition of being born without pain sensation, often with normal touch, leading to high risk of injury.
- **dissociation** : A disruption in the normal integration of consciousness, memory, identity, perception, or control; experience and behavior can come apart.
- **p-zombie** : A being physically and behaviorally identical to a human but lacking conscious experience; used in arguments about physicalism.
- **epiphenomenalism** : The view that mental events are by-products of physical processes and exert no causal influence on the physical.
- **conceivability** : Coherent imaginability of a scenario; often used in modal arguments (e.g., zombies) to suggest metaphysical possibility.
...
- **nociceptor** : a specialist type of nerve cell that responds to potentially harmful or dangerous stimuli, sending messages to the spinal cord and brain.

- **nociceptive pain** : Pain arising from activation of nociceptors by actual or potential tissue-damaging stimuli (as opposed to neuropathic pain).
- **A-fibres** : Fast, myelinated afferent fibers (especially A‑delta) that convey sharp, well-localized pain and some temperature information.
- **C-fibres** : Slow, unmyelinated afferent fibers that convey dull, diffuse, lingering pain (and some temperature/itch).
- **gate control theory** : Melzack and Wall’s theory that the spinal cord “gate” modulates pain signals based on peripheral input and descending control.
- **endorphins** : Endogenous opioid peptides (e.g., β‑endorphin) that bind opioid receptors to reduce pain and modulate stress and reward.
...
- **reductive materialism** : The claim that mental states/properties are nothing over and above physical states/properties and can be reduced to them.

- **mind–brain identity theory** : the thesis that mental states are identical to brain states.  

- **type identity theory** : The identity view that kinds of mental states (types) are identical to kinds of brain states (e.g., pain = C‑fiber firing).

- **multiple realisability** : The idea that the same mental state or function can be realized by different physical substrates or organizations.

- **eliminative materialism** :  a materialist account of the mind body problem that says our everyday common sense “folk psychology” view of the world is wrong, and that some of the mental states we think exist in fact do not. We are fooled by our language into thinking that "believe" and "desire" refer to real things.

- **folk psychology** : Common-sense explanatory scheme of beliefs, desires, intentions, and emotions used to predict and explain behavior.
...
- **functionalism** : the account of the mind-body relationship that states that all that matters is the causal or functional relationship between mental states. the mind performs computations. the details of what the functional relationships are implemented in doesn’t matter in the same way that a computer program does not need a specific arrangement of transistors to run.

- **substrate independence** : the idea that it’s what computers and brains do - the software - that’s important



- **neuroprothesis** : A device replacing or extending the brain's functionality.

- **China brain** : Block’s thought experiment in which the population of China instantiates the functional organization of a brain, used to test views about consciousness and functionalism.


- **syntax** : The formal structure and rules for manipulating symbols, independent of their meaning.
- **semantics** : The meanings, references, or truth-conditions associated with symbols or representations.
...
- **computation** : the use of well-defined algorithm or set of algorithms to generate an output. more broadly a metaphor for how the mind works

- **strong AI** : The claim that an appropriately programmed computer literally has a mind and genuine understanding, not mere simulation.


- **Chinese room** : Searle’s thought experiment arguing that executing syntax (a program) is insufficient for semantics/understanding.

- **systems reply** : A response to the Chinese room: while the man doesn’t understand, the whole system (man + rules + symbols) does.
...
- **dancing qualia** : Chalmers’s argument that if functional organization stays fixed across substrate changes, qualia can’t “dance” undetectably; supports organizational invariance.

- **organisational invariance** : The principle that conscious experience depends only on a system’s abstract causal organization, not its material substrate.

- **mysterianism** : The view (e.g., McGinn) that humans are cognitively closed to solving the hard problem of consciousness.

- **cognitive closure** : The idea that some truths are in principle inaccessible to a type of mind given its cognitive capacities.
...
- **non-reductive materialism** : Everything is physical, but mental properties are not reducible; they supervene on the physical and may have distinct causal roles.

- **private knowledge** : knowledge to which only you have access 
- **robot** : a machine controlled by a computer that is capable of interacting with the environment and that is capable of carrying out a complex sequence of actions automatically.  
- **ego theory** : the theory of the self that says that there is a single unified self that  
...
- **Swampman** : Davidson’s thought experiment about a lightning-created duplicate of a person with no causal history, used to probe meaning, content, and personal identity.
- **mind** : The set of capacities for consciousness, thinking, feeling, intending, and perceiving, typically realized by brain processes.
- **brain** : The central organ of the nervous system that processes information, coordinates behavior, and underlies mental functions.


- **mereological fallacy** : confusing the brain and mind by making statements such as “the brain believes”
- **qualia/quale** : the elements of sensation; the individual components of conscious experience


- **substance dualism/Cartesian dualism** : the same as cartesian dualism - the idea that there are two basic types of substance

- **res extensa** : “Extended substance” in Descartes: matter that occupies space.
- **res cogitans** : “Thinking substance” in Descartes: mind or consciousness.

- **pineal gland** : a small gland near the centre of the brain between the two hemispheres. thought to be the seat of the soul and where mind interacts with matter by descartes
...
- **materialism/physicalism** : the philosophical proposal that matter is the only fundamental kind of stuff in the universe

- **determinism** : the notion that everything is already determined by previous events. the laws of physics mean that every event now can only have one outcome





- **knowledge argument** : Jackson’s thought experiment about mary the super-scientist who is kept in a monochrome environment all her life. she knows everything there is to know about vision and the physics of colour. she is suddenly presented with a red rose. will she learn anything new? if you think she does the thought experiment is an argument against physicalism.

- **knowledge argument** : an argument illustrated by the thought experiment of mary the scientist who sees the world in black and white and then is given a coloured rose; is it possible to know all there is about colour without experiencing it? the knowledge argument is considered to be one of the strongest ripostes to materialism. 

- **inverted spectrum** :  a thought experiment, whereby individuals 'see' different colors; for example, when I have a sensation of red, you have a sensation of blue. How could we ever know?


- **nociceptor** : a specialist type of nerve cell that responds to potentially harmful or dangerous stimuli
...
- **eliminative materialism** :  a materialist account of the mind body problem that says our everyday common sense “folk psychology” view of the world is wrong
